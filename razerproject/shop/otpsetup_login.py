...
def login(email, password):
    ...
    try:
        ...
        description_text = page.inner_text(".modal-description.mb-15.text-gray").strip()
        # Check modal text
     
        if description_text == "Enter the code generated by your authenticator":
            print("Authenticator OTP required → returning False")
            return False
        else:
            print("Different modal text → returning True")
            return True

    except:
        print("OTP modal or description not found → returning True")
        return True
